...
$product_thumbnail   = get_the_post_thumbnail_url( $product_id, 'medium' );
		...
		<div class="product-info">
			...
			<h6 class="product-price text-gray-800 font-semibold mr-3 mb-5">
				...
				if ( ! empty( $discount_percent ) ) {
					?>
					<span class="product-discount text-green-600 font-bold text-sm font-normal"><?php echo round( $discount_percent, 2 ); ?>% OFF</span>
					<?php
				}
				?>
			</h6>
